    ...
    async with Drone.conversation(event.chat_id) as conv: 
        if s != True:
            ...
            try:
                ...
                if value > 10:
                    await conv.send_message("You can only get upto 10 files in a single batch.If you want to do 10k files in a single batch then contact @INSIGHT_ASSISTANT_BOT *Note* :-Its premium feature price = 100")
                    return conv.cancel()
            except ValueError:
